...
import { PROFILE_ROUTES } from '@/config/routes';
...
/**
 * Provides header state based on the current route.
 * Used to switch between logo and back button on profile-like routes.
 */
